...
begin
  for v_constraint in
    select * from (values
      ...
      ('app.school_settings', 'school_settings_lockdown_actor_fkey', 'foreign key (lockdown_activated_by) references iam.profiles(id) on delete set null'),
      ...
      ('app.classes', 'classes_year_fkey', 'foreign key (academic_year_id) references app.academic_years(id) on delete restrict'),
      ('app.classes', 'classes_teacher_fkey', 'foreign key (teacher_profile_id) references iam.profiles(id) on delete set null'),
      ...
      ('app.students', 'students_class_fkey', 'foreign key (class_id) references app.classes(id) on delete set null'),
      ('app.students', 'students_creator_fkey', 'foreign key (created_by) references iam.profiles(id) on delete set null'),
      ...
      ('app.student_guardians', 'student_guardians_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ('app.student_guardians', 'student_guardians_profile_fkey', 'foreign key (profile_id) references iam.profiles(id) on delete set null'),
      ('app.student_guardians', 'student_guardians_creator_fkey', 'foreign key (created_by) references iam.profiles(id) on delete set null'),
      ...
      ('app.student_enrollments', 'student_enrollments_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ('app.student_enrollments', 'student_enrollments_year_fkey', 'foreign key (academic_year_id) references app.academic_years(id) on delete restrict'),
      ('app.student_enrollments', 'student_enrollments_class_fkey', 'foreign key (class_id) references app.classes(id) on delete restrict'),
      ('app.student_enrollments', 'student_enrollments_creator_fkey', 'foreign key (created_by) references iam.profiles(id) on delete set null'),
      ...
      ('app.student_enrollment_events', 'enrollment_events_enrollment_fkey', 'foreign key (enrollment_id) references app.student_enrollments(id) on delete cascade'),
      ('app.student_enrollment_events', 'enrollment_events_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ('app.student_enrollment_events', 'enrollment_events_actor_fkey', 'foreign key (actor_profile_id) references iam.profiles(id) on delete set null'),
      ('app.parent_invitations', 'parent_invitations_school_fkey', 'foreign key (school_id) references app.schools(id) on delete cascade'),
      ('app.parent_invitations', 'parent_invitations_profile_fkey', 'foreign key (profile_id) references iam.profiles(id) on delete cascade'),
      ('app.parent_invitations', 'parent_invitations_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ('app.parent_invitations', 'parent_invitations_inviter_fkey', 'foreign key (invited_by) references iam.profiles(id) on delete restrict'),
      ...
      ('app.card_print_requests', 'card_requests_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ('app.card_print_requests', 'card_requests_year_fkey', 'foreign key (academic_year_id) references app.academic_years(id) on delete restrict'),
      ('app.card_print_requests', 'card_requests_actor_fkey', 'foreign key (requested_by) references iam.profiles(id) on delete restrict'),
      ...
      ('app.security_portals', 'security_portals_location_fkey', 'foreign key (location_id) references app.locations(id) on delete set null'),
      ...
      ('app.student_cards', 'student_cards_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ('app.student_cards', 'student_cards_replacement_fkey', 'foreign key (replaced_by_card_id) references app.student_cards(id) on delete set null'),
      ...
      ('app.security_events', 'security_events_student_fkey', 'foreign key (student_id) references app.students(id) on delete set null'),
      ('app.security_events', 'security_events_card_fkey', 'foreign key (card_id) references app.student_cards(id) on delete set null'),
      ('app.security_events', 'security_events_location_fkey', 'foreign key (location_id) references app.locations(id) on delete set null'),
      ('app.security_events', 'security_events_portal_fkey', 'foreign key (portal_id) references app.security_portals(id) on delete set null'),
      ('app.security_events', 'security_events_scanner_fkey', 'foreign key (scanned_by) references iam.profiles(id) on delete set null'),
      ('app.security_events', 'security_events_authorized_person_fkey', 'foreign key (authorized_person_id) references app.student_guardians(id) on delete set null'),
      ...
      ('app.alerts', 'alerts_rule_fkey', 'foreign key (rule_id) references app.alert_rules(id) on delete set null'),
      ('app.alerts', 'alerts_assignee_fkey', 'foreign key (assigned_to) references iam.profiles(id) on delete set null'),
      ('app.alerts', 'alerts_ack_actor_fkey', 'foreign key (acknowledged_by) references iam.profiles(id) on delete set null'),
      ('app.alerts', 'alerts_resolve_actor_fkey', 'foreign key (resolved_by) references iam.profiles(id) on delete set null'),
      ...
      ('app.alert_notifications', 'alert_notifications_alert_fkey', 'foreign key (alert_id) references app.alerts(id) on delete cascade'),
      ('app.alert_notifications', 'alert_notifications_profile_fkey', 'foreign key (profile_id) references iam.profiles(id) on delete set null'),
      ('app.fee_structures', 'fee_structures_school_fkey', 'foreign key (school_id) references app.schools(id) on delete cascade'),
      ('app.fee_structures', 'fee_structures_year_fkey', 'foreign key (academic_year_id) references app.academic_years(id) on delete restrict'),
      ...
      ('app.student_fees', 'student_fees_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ('app.student_fees', 'student_fees_structure_fkey', 'foreign key (fee_structure_id) references app.fee_structures(id) on delete restrict'),
      ...
      ('app.cash_registers', 'cash_registers_opener_fkey', 'foreign key (opened_by) references iam.profiles(id) on delete set null'),
      ('app.cash_registers', 'cash_registers_closer_fkey', 'foreign key (closed_by) references iam.profiles(id) on delete set null'),
      ...
      ('app.fee_payments', 'fee_payments_student_fee_fkey', 'foreign key (student_fee_id) references app.student_fees(id) on delete restrict'),
      ('app.fee_payments', 'fee_payments_receiver_fkey', 'foreign key (received_by) references iam.profiles(id) on delete restrict'),
      ('app.fee_payments', 'fee_payments_canceller_fkey', 'foreign key (cancelled_by) references iam.profiles(id) on delete set null'),
      ...
      ('app.cash_register_closures', 'cash_closures_register_fkey', 'foreign key (cash_register_id) references app.cash_registers(id) on delete restrict'),
      ('app.cash_register_closures', 'cash_closures_actor_fkey', 'foreign key (closed_by) references iam.profiles(id) on delete restrict'),
      ...
      ('app.fee_control_campaigns', 'fee_campaigns_structure_fkey', 'foreign key (fee_structure_id) references app.fee_structures(id) on delete restrict'),
      ('app.fee_control_campaigns', 'fee_campaigns_creator_fkey', 'foreign key (created_by) references iam.profiles(id) on delete restrict'),
      ...
      ('app.fee_control_assignees', 'fee_assignees_campaign_fkey', 'foreign key (campaign_id) references app.fee_control_campaigns(id) on delete cascade'),
      ('app.fee_control_assignees', 'fee_assignees_profile_fkey', 'foreign key (profile_id) references iam.profiles(id) on delete cascade'),
      ('app.fee_control_scans', 'fee_scans_school_fkey', 'foreign key (school_id) references app.schools(id) on delete cascade'),
      ('app.fee_control_scans', 'fee_scans_campaign_fkey', 'foreign key (campaign_id) references app.fee_control_campaigns(id) on delete restrict'),
      ('app.fee_control_scans', 'fee_scans_student_fkey', 'foreign key (student_id) references app.students(id) on delete restrict'),
      ('app.fee_control_scans', 'fee_scans_scanner_fkey', 'foreign key (scanned_by) references iam.profiles(id) on delete restrict'),
      ('app.fee_control_scans', 'fee_scans_location_fkey', 'foreign key (location_id) references app.locations(id) on delete set null'),
      ('app.subjects', 'subjects_school_fkey', 'foreign key (school_id) references app.schools(id) on delete cascade'),
      ('app.subjects', 'subjects_year_fkey', 'foreign key (academic_year_id) references app.academic_years(id) on delete restrict'),
      ...
      ('app.teacher_assignments', 'teacher_assignments_year_fkey', 'foreign key (academic_year_id) references app.academic_years(id) on delete restrict'),
      ('app.teacher_assignments', 'teacher_assignments_class_fkey', 'foreign key (class_id) references app.classes(id) on delete cascade'),
      ('app.teacher_assignments', 'teacher_assignments_subject_fkey', 'foreign key (subject_id) references app.subjects(id) on delete cascade'),
      ('app.teacher_assignments', 'teacher_assignments_profile_fkey', 'foreign key (teacher_profile_id) references iam.profiles(id) on delete cascade'),
      ...
      ('app.assignments', 'assignments_year_fkey', 'foreign key (academic_year_id) references app.academic_years(id) on delete restrict'),
      ('app.assignments', 'assignments_class_fkey', 'foreign key (class_id) references app.classes(id) on delete restrict'),
      ('app.assignments', 'assignments_subject_fkey', 'foreign key (subject_id) references app.subjects(id) on delete restrict'),
      ('app.assignments', 'assignments_teacher_fkey', 'foreign key (teacher_profile_id) references iam.profiles(id) on delete restrict'),
      ...
      ('app.assignment_questions', 'assignment_questions_assignment_fkey', 'foreign key (assignment_id) references app.assignments(id) on delete cascade'),
      ...
      ('app.grades', 'grades_assignment_fkey', 'foreign key (assignment_id) references app.assignments(id) on delete cascade'),
      ('app.grades', 'grades_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ('app.grades', 'grades_creator_fkey', 'foreign key (created_by) references iam.profiles(id) on delete restrict'),
      ('app.grades', 'grades_updater_fkey', 'foreign key (updated_by) references iam.profiles(id) on delete set null'),
      ...
      ('app.lesson_plans', 'lesson_plans_year_fkey', 'foreign key (academic_year_id) references app.academic_years(id) on delete restrict'),
      ('app.lesson_plans', 'lesson_plans_class_fkey', 'foreign key (class_id) references app.classes(id) on delete restrict'),
      ('app.lesson_plans', 'lesson_plans_subject_fkey', 'foreign key (subject_id) references app.subjects(id) on delete restrict'),
      ('app.lesson_plans', 'lesson_plans_teacher_fkey', 'foreign key (teacher_profile_id) references iam.profiles(id) on delete restrict'),
      ('app.lesson_plans', 'lesson_plans_homework_fkey', 'foreign key (homework_assignment_id) references app.assignments(id) on delete set null'),
      ('app.approval_requests', 'approval_requests_school_fkey', 'foreign key (school_id) references app.schools(id) on delete cascade'),
      ('app.approval_requests', 'approval_requests_requester_fkey', 'foreign key (requested_by) references iam.profiles(id) on delete restrict'),
      ('app.approval_requests', 'approval_requests_decider_fkey', 'foreign key (decided_by) references iam.profiles(id) on delete set null'),
      ...
      ('app.rankings', 'rankings_class_fkey', 'foreign key (class_id) references app.classes(id) on delete cascade'),
      ('app.rankings', 'rankings_computer_fkey', 'foreign key (computed_by_profile_id) references iam.profiles(id) on delete set null'),
      ...
      ('app.ranking_entries', 'ranking_entries_ranking_fkey', 'foreign key (ranking_id) references app.rankings(id) on delete cascade'),
      ('app.ranking_entries', 'ranking_entries_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ...
      ('app.ranking_stars', 'ranking_stars_ranking_fkey', 'foreign key (ranking_id) references app.rankings(id) on delete cascade'),
      ('app.ranking_stars', 'ranking_stars_student_fkey', 'foreign key (student_id) references app.students(id) on delete cascade'),
      ('app.ranking_stars', 'ranking_stars_parent_fkey', 'foreign key (parent_profile_id) references iam.profiles(id) on delete cascade'),
      ...
      ('iam.devices', 'devices_profile_fkey', 'foreign key (profile_id) references iam.profiles(id) on delete cascade'),
      ...
      ('iam.roles', 'roles_creator_fkey', 'foreign key (created_by) references iam.profiles(id) on delete set null'),
      ...
      ('iam.profile_roles', 'profile_roles_profile_fkey', 'foreign key (profile_id) references iam.profiles(id) on delete cascade'),
      ('iam.profile_roles', 'profile_roles_role_fkey', 'foreign key (role_id) references iam.roles(id) on delete cascade'),
      ('iam.profile_roles', 'profile_roles_assigner_fkey', 'foreign key (assigned_by) references iam.profiles(id) on delete set null'),
      ...
      ('iam.role_permission_grants', 'role_grants_role_fkey', 'foreign key (role_id) references iam.roles(id) on delete cascade'),
      ...
      ('iam.role_permission_grants', 'role_grants_scope_fkey', 'foreign key (scope_code) references iam.scopes(code) on delete restrict'),
      ('iam.role_permission_grants', 'role_grants_actor_fkey', 'foreign key (granted_by) references iam.profiles(id) on delete set null'),
      ...
      ('iam.permission_conditions', 'permission_conditions_grant_fkey', 'foreign key (grant_id) references iam.role_permission_grants(id) on delete cascade'),
      ('iam.permission_conditions', 'permission_conditions_creator_fkey', 'foreign key (created_by) references iam.profiles(id) on delete set null'),
      ...
      ('iam.profile_permission_exceptions', 'profile_exceptions_profile_fkey', 'foreign key (profile_id) references iam.profiles(id) on delete cascade'),
      ...
      ('iam.profile_permission_exceptions', 'profile_exceptions_scope_fkey', 'foreign key (scope_code) references iam.scopes(code) on delete restrict'),
      ('iam.profile_permission_exceptions', 'profile_exceptions_actor_fkey', 'foreign key (granted_by) references iam.profiles(id) on delete restrict'),
      ...
      ('iam.scope_assignments', 'scope_assignments_school_fkey', 'foreign key (school_id) references app.schools(id) on delete cascade'),
      ('iam.scope_assignments', 'scope_assignments_profile_fkey', 'foreign key (profile_id) references iam.profiles(id) on delete cascade'),
      ('iam.scope_assignments', 'scope_assignments_scope_fkey', 'foreign key (scope_code) references iam.scopes(code) on delete restrict'),
      ('iam.scope_assignments', 'scope_assignments_actor_fkey', 'foreign key (assigned_by) references iam.profiles(id) on delete set null'),
      ('iam.scope_assignments', 'scope_assignments_dates_check', 'check (ends_at is null or ends_at >= starts_at)'),
      ('audit.events', 'audit_events_school_fkey', 'foreign key (school_id) references app.schools(id) on delete restrict'),
      ('audit.events', 'audit_events_actor_fkey', 'foreign key (actor_profile_id) references iam.profiles(id) on delete set null'),
      ...
      ('ops.system_events', 'system_events_actor_fkey', 'foreign key (actor_profile_id) references iam.profiles(id) on delete set null'),
      ...
      ('ops.notifications', 'notifications_profile_fkey', 'foreign key (profile_id) references iam.profiles(id) on delete cascade'),
      ('ops.notifications', 'notifications_event_fkey', 'foreign key (event_id) references ops.system_events(id) on delete set null'),
...
create unique index if not exists role_grants_identity_idx on iam.role_permission_grants (role_id, permission_id, coalesce(scope_code, ''));
...
create unique index if not exists profile_exceptions_identity_idx on iam.profile_permission_exceptions (profile_id, permission_id);
create unique index if not exists scope_assignments_identity_idx on iam.scope_assignments (profile_id, scope_code, coalesce(target_id, '00000000-0000-0000-0000-000000000000'::uuid));
...
create index if not exists scope_assignments_lookup_idx on iam.scope_assignments (profile_id, scope_code, target_id, is_active);
